...
export default function HowItWorks() {
  return (
    <section style={{
      padding: "var(--section-pad)", background: "#fafafa",
        ...
        <div style={{
          ...
          {steps.map((s, i) => (
            <div key={i}>
              <div style={{
                fontFamily: "'Playfair Display',serif",
                fontSize: "clamp(48px,6vw,72px)", fontWeight: 400,
                color: "#e5e5e5", lineHeight: 1, marginBottom: "16px",
              }}>{s.n}</div>
              <h3 style={{
                fontFamily: "'Playfair Display',serif",
